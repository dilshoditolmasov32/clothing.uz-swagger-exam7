...
var ToggleButtonGroup = React3.forwardRef(function ToggleButtonGroup2(inProps, ref) {
  ...
  const handleChange = React3.useCallback((event, buttonValue) => {
    if (!onChange) {
      return;
    }
  ...
  const handleExclusiveChange = React3.useCallback((event, buttonValue) => {
    if (!onChange) {
      return;
    }
...
//# sourceMappingURL=chunk-FFRKQ7QO.js.map
