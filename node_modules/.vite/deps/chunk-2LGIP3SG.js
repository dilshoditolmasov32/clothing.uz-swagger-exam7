...
var _excluded6 = ["className", "color", "edge", "size", "sx"];
...
var Switch = React11.forwardRef(function Switch2(inProps, ref) {
  ...
  const icon = (0, import_jsx_runtime13.jsx)(SwitchThumb, {
    className: classes.thumb,
    ownerState
  });
  return (0, import_jsx_runtime14.jsxs)(SwitchRoot, {
    className: clsx_default(classes.root, className),
    sx,
    ownerState,
    children: [(0, import_jsx_runtime13.jsx)(SwitchSwitchBase, _extends({
      type: "checkbox",
      icon,
      checkedIcon: icon,
      ref,
    ...
    })), (0, import_jsx_runtime13.jsx)(SwitchTrack, {
...
//# sourceMappingURL=chunk-2LGIP3SG.js.map
